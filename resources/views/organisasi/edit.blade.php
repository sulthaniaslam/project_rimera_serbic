...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="fas fa-chalkboard-teacher"></i> Edit Data Struktur Organisasi</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="card card-primary card-outline">
        ...
        <div class="card-body">
          <form action="{{route('struktur_organisasi_edit', $edit->id_so)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                  <label for="1" class="form-label">Pilih Photo</label><p>
                  <input type="file" name="photo" id="imgInp" onchange="previewImage();">
                </div> <P>
                  <img src="{{asset('gambar')}}/{{$edit->photo}}" class="img-thumbnail" width="150px" alt="Gambar Struktur organisasi"><br>
                  <img id="img-upload"  style="width: 150px; height: 150px;" alt="image Upload" /><p>
                <button type="submit" class="btn btn-primary">Update</button>
                <a href="{{url('struktur_organisasi')}}" class="btn btn-warning">back</a>
            </form>
        </div>
