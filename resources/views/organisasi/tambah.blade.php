...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="fas fa-chalkboard-teacher"></i> Tambah Data Struktur Organisasi</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="card card-primary card-outline">
        ...
        <div class="card-body">
          <form action="{{route('struktur_organisasi_add')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
